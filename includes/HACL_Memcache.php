...
//echo "Retrieved permission from memcache: $key => $permission<br />\n";		
	 ...
	 * 		Returns always true.
	 */
	public static function onMoveArticle(Title &$oldTitle, Title &$newTitle) {
	 ...
	 * 		Returns always true.
	 */
	public static function onAddSecurityDescriptor($sdTitle, $nameOfPE, $peType) {
	 ...
	 * 		Returns always true.
	 */
	public static function onModifySecurityDescriptor($sdTitle, $nameOfPE, $peType) {
		self::getInstance()->sdChanged($sdTitle, $nameOfPE, $peType);
		return true;
	}
	 ...
	 * 		Returns always true.
	 */
	public static function onDeleteSecurityDescriptor($sdTitle, $nameOfPE, $peType) {
		self::getInstance()->sdChanged($sdTitle, $nameOfPE, $peType);
		return true;
	}
	 ...
	 * 		Returns always true.
	 */
	public static function onAddGroup(Title $groupTitle) {
	 ...
	 * 		Returns always true.
	 */
	public static function onModifyGroup(Title $groupTitle) {
		self::getInstance()->groupChanged($groupTitle);
		return true;
	}
	 ...
	 * 		Returns always true.
	 */
	public static function onDeleteGroup(Title $groupTitle) {
		self::getInstance()->groupChanged($groupTitle);
		return true;
	}
	 ...
	 * 		Returns always true.
	 */
	public static function onModifyWhitelist() {
		self::getInstance()->purgeCache();
		return true;
	}
	 ...
	 * 		Returns always true.
	 */
	public static function onDeleteWhitelist() {
		self::getInstance()->purgeCache();
		return true;
	}
