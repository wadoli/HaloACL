...
HTML;
        if ($processType <> "createAclUserTemplate") {
        	$SMWInstalled = defined('SMW_VERSION') ? "" : 'disabled="true"';
            $html .= <<<HTML
                        <div class="haloacl_tab_section_content_row_content_element">
                            <input $SMWInstalled type="radio" class="create_acl_general_protect" name="create_acl_general_protect" id="hacl_general_protect_property" value="property" onClick="resetName();"/>&nbsp;$hacl_createGeneralContent_5
                        </div>
                        <div class="haloacl_tab_section_content_row_content_element">
